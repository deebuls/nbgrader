...
def get_file_names(file_path):
    """ Returns a list of all file names in the given file_path.
    It supports wild-cards e.g. *.jpg """
    return glob.glob(file_path)

# NOTES: All of this should be eventually in a class
...
if __name__ == "__main__":
    #sentence_1 = 'there is a cat and the cat sat on a mat'
    sentence_1 = 'there is a cat and the and mat'
    ...
    #sentence_2 = 'there is a mat and on the mat sat the cat'
    sentence_2 = 'there is a mat and on the mat sat'
